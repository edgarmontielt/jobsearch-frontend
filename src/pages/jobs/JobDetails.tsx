          ...
          {job && (
            <>
              <div className=" flex items-center ">
                ...
                <p className=" ml-auto text-xl font-medium bg-blue-300 text-blue-900 py-3 px-10 rounded-full hover:opacity-70 cursor-pointer"
                  onClick={aplyJob}>
                  Postularse
                </p>
              </div>
              ...
              <p className=" mb-10">
                Numero de aplicantes: {job.aplicants?.length}
              </p>
